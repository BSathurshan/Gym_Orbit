    ...
    <div class="in-in-content">
        ...
        if (isset($post['found']) && $post['found'] == 'yes') {
            while ($posts = $post['result']->fetch_assoc()) {
                ...
                echo "<img class='zoom2' src='" . ROOT . "/assets/images/posts/images/" . htmlspecialchars($posts["file"]) . "'>";
                echo "</div>";
...
<!-- Overlay for post image zoom -->
<div id="zoom2-overlay" onclick="this.style.display='none'">
    <img src="" alt="Zoomed Post Image">
</div>
