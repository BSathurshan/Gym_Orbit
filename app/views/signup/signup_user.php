    ...
    <div class="signup-container">
        <form id="signupForm" action="<?= ROOT ?>/signup/addUser" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-slide">
                <h2>Step 2: Profile Photo (Optional)</h2>
            ...
            <div class="form-slide">
                ...
                <input type="tel" name="contact" id="contact" pattern="\+94[0-9]{9}" placeholder="+94712345678" required>
                <span id="contactFeedback" class="feedback"></span>
                <label for="location">Address:</label>
                <input type="text" name="location" id="location" required>
                <label for="health">Any health concerns (Optional):</label>
                ...
                <span id="activeModeFeedback" class="feedback"></span>
                <div class="button-grp">
                    <button type="button" class="prev-btn">Back</button>
                    <button type="button" class="next-btn">Next</button>
                </div>
