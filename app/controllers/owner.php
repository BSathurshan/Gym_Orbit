...
class Owner
{
    ...
    public function get_instructors($username)
    {
        if (!empty($username)) {
            ...
            $status = "error";
            $message = "Missing gym's username (get_instructors).";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
    }
    ...
    public function get_requests($username)
    {
        if (!empty($username)) {
            ...
            $status = "error";
            $message = "Missing gym's username (get_requests).";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
    }
    ...
    public function get_machines($username)
    {
        if (!empty($username)) {
            ...
            $status = "error";
            $message = "Missing gym's username (get_machines).";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
    }
    ...
    public function get_members($username)
    {
        if (!empty($username)) {
            ...
            $status = "error";
            $message = "Missing gym's username (get_members).";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
    }
    ...
    public function addMachine()
    {
        ...
        elseif($result['found']=='no'){
            $status = "error";
            $message = "Error while adding machine!";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
        elseif($result['found']=='alert'){
            $status = "error";
            $message = "Machine name already in use!";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
    }
    ...
    public function editMachine()
    {
        ...
        if ($result['found']=='yes') {
            $status = "success";
            $message = "Machine has been edited!";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
        elseif($result['found']=='no'){
            $status = "error";
            $message = "Error while editing machine.";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
    }
    ...
    public function processRequest()
    {
        ...
        if ($result['found']=='yes1') {
            $status = "success";
            $message = "The request has been made by -$username accepted!";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
        ...
        elseif ($result['found']=='yes2') {
            $status = "success";
            $message = "The request has been made by -$username rejected!";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
    ...
    public function editInstructorSchedule()
    {
        ...
        if ($result['found']=='yes') {
            $status = "success";
            $message = "$trainer_name's schedule has been updated!";
            $this->view('owner', 'owner', ['message' => $message, 'status' => $status]);
        }
        elseif($result['found']=='no'){
            $status = "error";
