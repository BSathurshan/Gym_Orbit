...
function requestInstructor(username,name,gym_username,trainer_username,trainer_name) {
    ...
    if (confirm('Are you sure you want to request this instructor?')) {
        ...
        window.location.href = "./instructor/request.php?gym_username=" + encodeURIComponent(gym_username) +
...
function leaveGym(gym_username,username) {
    ...
    if (confirm('Are you sure you want to leave ?')) {
        ...
        window.location.href = "./gym/leave.php?gym_username=" + encodeURIComponent(gym_username) +  "&username=" + encodeURIComponent(username) ;
