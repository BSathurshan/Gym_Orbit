...
document.getElementById('searchQuery').addEventListener('input', function () {
    ...
    fetch('./users/search.php?search=' + encodeURIComponent(searchQuery))
...
document.getElementById('searchQuery2').addEventListener('input', function () {
    ...
    // Fetch user data dynamically based on the input
    fetch('./gym/search.php?search=' + encodeURIComponent(searchQuery2))
        .then(response => response.text())
        .then(data => {
            // Update the userResults container
...
document.getElementById('searchQuery3').addEventListener('input', function () {
    ...
    // Fetch user data dynamically based on the input
    fetch('./instructors/search.php?search=' + encodeURIComponent(searchQuery3))
        .then(response => response.text())
        .then(data => {
            // Update the userResults container
...
document.getElementById('searchQuery4').addEventListener('input', function () {
    ...
    // Fetch user data dynamically based on the input
    fetch('./admins/search.php?search=' + encodeURIComponent(searchQuery4))
        .then(response => response.text())
        .then(data => {
            // Update the userResults container
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    loadData('./users/search.php', 'userResults');
    loadData('./gym/search.php', 'ownerResults');
    loadData('./instructors/search.php', 'instructorResults');
    loadData('./admins/search.php', 'adminResults');
});
