...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveNote() {
        ...
        if (content) {
            ...
            fetch(ROOT + "/instructor/saveNote", {
                method: "POST",
    ...
    function deleteNote(id) {
        ...
        fetch(ROOT + "/instructor/deleteNote", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    function fetchSavedColors() {
        return fetch(ROOT + "/instructor/getSavedColors", {
            method: "GET",
            headers: { "Content-Type": "application/json" }
        })
        .then(response => {
    ...
    function updateColorInDatabase(date, color) {
        ...
        fetch(ROOT + "/instructor/updateTodayColor", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    function updateAvailabilityInDatabase() {
        ...
        fetch(ROOT + "/instructor/updateAvailability", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
    ...
    function fetchNotesFromDatabase() {
        return fetch(ROOT + "/instructor/getNotes", {
            method: "GET",
            headers: { "Content-Type": "application/json" }
        })
        .then(response => {
